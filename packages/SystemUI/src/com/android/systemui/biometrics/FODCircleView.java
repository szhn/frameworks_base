...
public class FODCircleView extends ImageView implements ConfigurationListener {
    ...
    private final int[] ICON_STYLES = {
        R.drawable.fod_icon_0,
        R.drawable.fod_icon_1,
        R.drawable.fod_icon_2,
        R.drawable.fod_icon_3,
        R.drawable.fod_icon_4,
        R.drawable.fod_icon_5,
        R.drawable.fod_icon_6,
        R.drawable.fod_icon_7,
        R.drawable.fod_icon_8,
        R.drawable.fod_icon_9,
        R.drawable.fod_icon_10,
        R.drawable.fod_icon_11,
        R.drawable.fod_icon_12,
        R.drawable.fod_icon_13,
        R.drawable.fod_icon_14,
        R.drawable.fod_icon_15,
        R.drawable.fod_icon_16,
        R.drawable.fod_icon_17,
        R.drawable.fod_icon_18,
        R.drawable.fod_icon_19,
        R.drawable.fod_icon_20,
